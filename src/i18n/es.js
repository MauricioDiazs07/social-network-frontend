export default {
    ...
    chooseSection: 'Escoge una sección',
    chooseInterest: 'Escoge un interés',
    chooseInterestFromList: 'Escoge un interés de la lista para buscar publicaciones',
    close: 'CERRAR',
    ...
    selectObInterests: 'Selecciona, al menos, un interés',
    ...
    WrongCredentials: 'Número o contraseña incorrectos',
    WrongPhone: 'Número no registrado',
    yesLogOut: 'Sí, salir',
    you: 'Tú',
